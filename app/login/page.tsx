...
import { DailyQuote } from "@/components/kira/daily-quote";
    ...
    <main id="main-content" className="login-stage">
      <div className="login-intro">
        ...
        <h1>
          A little more room
          <br />
          <em>to be the author.</em>
        </h1>
        <p>
          The books are yours. The decisions are yours. Let the business finally
      ...
      <section className="login-card" aria-labelledby="login-title">
        ...
        {canSignIn ? (
          ...
          <>
            <p role="alert">
              This account has not been added to this workspace. Ask your
              workspace owner for access.
            </p>
            <form action="/auth/logout" method="post">
              <Button type="submit">Use another account</Button>
            </form>
          </>
        ) : (
          <>
            <p role="alert">
              {session.authorization === "unavailable"
                ...
                : "Your private workspace is being prepared. Your workspace owner can finish the connection in the setup guide."}
            </p>
            <p className="quiet-note">
              Private workspace access stays closed until the connection is
              ready.
            </p>
            {session.user && (
              <form action="/auth/logout" method="post">
