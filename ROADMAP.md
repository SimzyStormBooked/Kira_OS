...
- Character Studio phase 1 is the schema in `202609210001_character_studio.sql`: author-owned character identity, reversible author-confirmed book links, author notes, and private portraits with retained rights. It is verified locally and applied to the hosted database (September 21, 2026). The Studio interface, the sanitizing upload route, the home showcase, and the Quiet Room are not built. See [docs/character-studio.md](docs/character-studio.md).
