...
Migration `202609230001_manuscript_batch_recovery.sql` was applied at **2026-09-23 22:16:47 UTC**, under the shared migration advisory lock and author-row locks, using verified TLS. Both batch-lineage and canonical passage-set uniqueness indexes were verified before commit. There were zero pending manuscript batches and zero active reading jobs. This adds recovery controls without changing saved manuscripts or weakening citation validation. See [the sanitized migration record](docs/manuscript-recovery-hosted-checkpoint.json). At this pre-deployment checkpoint Syndicate Princess had 232 of 421 saved passages; completion is not claimed here.
